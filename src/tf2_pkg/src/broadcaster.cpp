  ...
  op_flag_(true)
{
  ...
  auto broadcast =
    [this]() -> void
    {
      ...
      tf_stamped.child_frame_id = "seg1";
      ...
      tf_stamped.header.frame_id = "seg1";
      tf_stamped.child_frame_id = "seg2";
      tf_stamped.transform.translation.x = 0.0;
      tf_stamped.transform.translation.y = 0.0;
      tf_stamped.transform.translation.z = 0.1;
      ...
      tf_stamped.header.frame_id = "seg2";
      tf_stamped.child_frame_id = "seg3";
      tf_stamped.transform.translation.x = 0.0;
      tf_stamped.transform.translation.y = 0.0;
      tf_stamped.transform.translation.z = 0.1;
      ...
      tf_stamped.header.frame_id = "seg3";
      tf_stamped.child_frame_id = "seg4";
      tf_stamped.transform.translation.x = 0.0;
      tf_stamped.transform.translation.y = 0.0;
      tf_stamped.transform.translation.z = 0.1;
