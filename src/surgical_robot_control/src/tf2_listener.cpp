  ...
  tf_listener_(tf_buffer_)
{
  auto listen =
    [this]() -> void
    {
      ...
      try {
        tf_world_pan = tf_buffer_.lookupTransform("left_seg_pan_1", "world", tf2::timeFromSec(0));
        ...
        tf_pan_world = tf_buffer_.lookupTransform("world", "left_seg_pan_1", tf2::timeFromSec(0));
  ...
  timer_ = this->create_wall_timer(50ms, listen);
}
